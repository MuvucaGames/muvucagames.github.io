...
(function() {
 var loadPackage = function(metadata) {
    ...
    var PACKAGE_NAME = 'AgoraFoi.data';
    var REMOTE_PACKAGE_BASE = 'AgoraFoi.data';
    ...
    var REMOTE_PACKAGE_NAME = typeof Module['locateFile'] === 'function' ?
      ...
      var REMOTE_PACKAGE_SIZE = 9397232;
      var PACKAGE_UUID = 'bc0391a7-b247-49ff-9608-51747db2f42e';
...
Module['FS_createPath']('/Managed/mono', '2.0', true, true);
    ...
    DataRequest.prototype = {
      ...
      new DataRequest(0, 5970041, 0, 0).open('GET', '/data.unity3d');
    new DataRequest(5970041, 5970062, 0, 0).open('GET', '/methods_pointedto_by_uievents.xml');
    new DataRequest(5970062, 5976771, 0, 0).open('GET', '/preserved_derived_types.xml');
    new DataRequest(5976771, 7873547, 0, 0).open('GET', '/Il2CppData/Metadata/global-metadata.dat');
    new DataRequest(7873547, 9369607, 0, 0).open('GET', '/Resources/unity_default_resources');
    new DataRequest(9369607, 9397232, 0, 0).open('GET', '/Managed/mono/2.0/machine.config');
    ...
    function processPackageData(arrayBuffer) {
      ...
      DataRequest.prototype.byteArray = byteArray;
          ...
          Module['removeRunDependency']('datafile_AgoraFoi.data');

    };
    Module['addRunDependency']('datafile_AgoraFoi.data');
